...
# ----------------------------------------------------------------------------------------------------------------------
download = True  # skip this step if you already have the dataset
fix = False  # skip this step if you already have the dataset
convert = False  # skip this step if you already have the dataset
# ----------------------------------------------------------------------------------------------------------------------
for DIR in ['../../../datasets/ozgenel/panoptic', '../../../datasets/ozgenel/annotations', '../../../datasets/ozgenel/BW_png']:
